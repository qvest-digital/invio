 ...
 */
public class DoubleCentroidMedianEliminatorTest {

    private DoubleCentroidMedianEliminator dcme;

    @Before
    public void setup() {
        dcme = new DoubleCentroidMedianEliminator(new XYPointFactory());
    }
    ...
    public void testThatNoPointIsEliminatedWhenTheTotalAmountOfPointsIsToSmall() throws NicTrackerException {
        ...
        final Set<NicGeoPoint> geoPointsOut = dcme.removeOutliers(geoPointsIn);
